...
export default class Config {
    ...
    public includePatterns: Array<string> = (process.env.INCLUDE_PATTERNS || '*.ts,*.json,*.yaml,*.md,.env.dist').split(',');
    public excludeDirs: Array<string> = (process.env.EXCLUDE_DIRS || 'node_modules,build,.git').split(',');
